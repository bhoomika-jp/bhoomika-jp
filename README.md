...
### Hey! I'm Bhoomika 👋
#### I am a highly motivated Data Engineer with a master’s degree in Business Analytics and one year of professional experience in data engineering. I specialize in designing, building, and optimizing ETL pipelines using SQL, Python, PySpark, and Databricks, enabling efficient data processing and integration across various platforms. With advanced proficiency in Power BI, I have successfully created and managed interactive dashboards and semantic models, translating complex datasets into actionable insights.

#### In addition to my technical expertise, I excel in cross-functional collaboration, gathering and understanding business requirements, and delivering tailored data solutions that meet organizational needs. I am passionate about leveraging data to drive decision-making and business growth, continuously enhancing my skills to stay at the forefront of data engineering innovations.

- 🔭 I’m currently working on more data engineering projects
- 🌱 I’m currently learning PySpark and Databricks
- 💬 Ask me about my current data project
- 😄 Pronouns: She/Her
